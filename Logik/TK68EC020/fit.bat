...
cpldfit.exe -intstyle ise -p xc95288xl-10-TQ144 -ofmt vhdl -htmlrpt -optimize speed -loc on -slew fast -init low -inputs 54 -pterms 34 -unused float -power std -terminate float TK68EC020.ngd >log.txt 
